...
import { useAppStore, Grade } from '@/store/useAppStore';
                    ...
                    {([11, 12] as Grade[]).map((g) => (
                      <button
                        ...
                        onClick={async () => {
                          ...
                          toast({
                            title: `Switched to Grade ${g}`,
                            description: `Questions will now match Class ${g} difficulty.`,
                          });
                        }}
                        className={cn(
                      ...
                      >
                        <GraduationCap className="mx-auto mb-1 h-6 w-6" />
                        <span className="text-lg font-bold">Class {g}</span>
                        <p className="text-xs text-muted-foreground mt-1">
                          {g === 11 ? 'Foundation (NCERT)' : 'Advanced'}
                        </p>
                      </button>
                    ))}
                  </div>
