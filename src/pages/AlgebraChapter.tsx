...
import { ArrowLeft, Scale, Factory, Sparkles, Lock, CheckCircle2 } from 'lucide-react';
...
const games = [
  {
    ...
    subtitle: 'Easy',
    description: 'Keep both sides equal with apples and mystery boxes',
    icon: Scale,
    concept: 'Variables as unknown objects, basic expressions',
  ...
  },
  {
    ...
    subtitle: 'Medium',
    description: 'Isolate the glowing variable cube',
    icon: Factory,
    concept: 'Solving simple equations visually',
  ...
  },
  {
    ...
    subtitle: 'Advanced',
    description: 'Discover hidden rules through portals',
    icon: Sparkles,
    concept: 'Algebraic patterns, substitution, simplification',
    gradient: 'from-indigo-200 to-blue-300',
    unlocked: false,
  },
];

export default function AlgebraChapter() {
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background">
        <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          >
            ...
            >
              Expressions • Equations • Balance • Patterns
            </motion.p>
            <motion.p 
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              Learn through calm abstract worlds and floating objects
            </motion.p>
          </motion.div>
          ...
          <div className="relative">
            ...
            <motion.div 
              ...
              className="absolute left-1/2 top-0 bottom-0 w-1 bg-gradient-to-b from-emerald-400/30 via-violet-400/20 to-indigo-400/10 -translate-x-1/2 rounded-full origin-top" 
            />
