...
import { ArrowLeft, Sun, Mountain, Waves, Lock, CheckCircle2 } from 'lucide-react';
...
const games = [
  {
    id: 'angle-shadow-garden',
    number: 1,
    title: 'Angle & Shadow Garden',
    subtitle: 'Easy',
    description: 'Learn how the sun creates shadows',
    icon: Sun,
    concept: 'Basic height–distance intuition (sin & cos visually)',
    gradient: 'from-amber-200 to-orange-300',
    unlocked: true,
  },
  {
    id: 'mountain-rope-rescue',
    number: 2,
    title: 'Mountain Rope Rescue',
    subtitle: 'Medium',
    description: 'Help the drone rescue a climber',
    icon: Mountain,
    concept: 'Heights & distances (tan intuition)',
  ...
  },
  {
    ...
    subtitle: 'Advanced',
    description: 'Master the energy of waves',
    icon: Waves,
    concept: 'Graphs & identities (sin²θ + cos²θ = 1)',
    gradient: 'from-violet-200 to-purple-300',
    unlocked: false,
  },
];

export default function TrigonometryChapter() {
  ...
  const isUnlocked = (gameIndex: number) => {
    ...
    return completedGames.includes(games[gameIndex - 1].id);
  };
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background">
        <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          >
            ...
            >
              Heights • Distances • Graphs • Identities
            </motion.p>
            <motion.p 
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              Learn through calm 3D worlds and gentle exploration
            </motion.p>
          </motion.div>
          ...
          <div className="relative">
            ...
            <motion.div 
              ...
              className="absolute left-1/2 top-0 bottom-0 w-1 bg-gradient-to-b from-primary/30 via-primary/20 to-primary/10 -translate-x-1/2 rounded-full origin-top" 
            />
